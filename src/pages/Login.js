...
const IconTiktok = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9 12C6.79086 12 5 13.7909 5 16C5 18.2091 6.79086 20 9 20C11.2091 20 13 18.2091 13 16V4C13.6667 5.33333 15.2 8 19 8"
      stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export default function Login() {
  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", fontFamily:"var(--font-body)", background:"#0A0A0F", overflow:"hidden" }}>
      ...
      {/* ── GAUCHE : formulaire ── */}
      <div style={{ width:"480px", flexShrink:0, display:"flex", flexDirection:"column", justifyContent:"center", padding:"60px 56px", position:"relative", zIndex:1 }}>

        {/* Logo */}
        <div style={{ marginBottom:"56px" }}>
          <div style={{ fontFamily:"var(--font-display)", color:"var(--gold)", fontSize:"28px", letterSpacing:"6px", fontWeight:"400", marginBottom:"6px" }}>LIVRR</div>
          <div style={{ fontSize:"9px", color:"rgba(255,255,255,0.25)", letterSpacing:"3px", textTransform:"uppercase" }}>Espace Boutique</div>
        </div>

        {/* Titre */}
        <div style={{ marginBottom:"40px" }}>
          <RevealText text="Connexion" tag="h1"
            style={{ fontSize:"40px", fontWeight:"300", color:"#fff", letterSpacing:"-0.01em", marginBottom:"10px" }}
            delay={100} stagger={150} />
          <p className="letter-fade" style={{ fontSize:"14px", color:"rgba(255,255,255,0.35)", lineHeight:1.6, animationDelay:"400ms" }}>
        ...
        <form onSubmit={handleLogin} style={{ display:"flex", flexDirection:"column", gap:"16px" }}>
          ...
          <div style={{ textAlign:"right" }}>
            <button type="button" style={{ fontSize:"12px", color:"rgba(201,169,110,0.6)", background:"none", border:"none", cursor:"pointer", fontFamily:"var(--font-body)" }}>
              Mot de passe oublié ?
            </button>
          </div>
        ...
        <div style={{ marginTop:"32px", textAlign:"center" }}>
          <span style={{ fontSize:"13px", color:"rgba(255,255,255,0.25)" }}>Pas encore partenaire ? </span>
            ...
            {SOCIAL_LINKS.map(({ label, href, Icon, color, bgHover, borderHover }) => (
              <a key={label} href={href} target="_blank" rel="noopener noreferrer" title={label}
                ...
                style={{
                  ...
                  border:`1px solid ${hoveredSocial===label ? borderHover : "rgba(255,255,255,0.08)"}`,
                  background: hoveredSocial===label ? bgHover : "rgba(255,255,255,0.03)",
                  display:"flex", alignItems:"center", justifyContent:"center",
                  color: hoveredSocial===label ? color : "rgba(255,255,255,0.3)",
                  transition:"all 0.2s ease", textDecoration:"none",
                  transform: hoveredSocial===label ? "translateY(-2px)" : "none",
                  boxShadow: hoveredSocial===label ? `0 4px 16px ${color}22` : "none",
                }}>
                <Icon />
              </a>
            ))}
      ...
      <div style={{ flex:1, position:"relative", overflow:"hidden" }}>
        ...
        <svg style={{ position:"absolute", inset:0, width:"100%", height:"100%", opacity:0.06 }} viewBox="0 0 600 800">
          ...
          <circle cx="300" cy="400" r="200" fill="none" stroke="#C9A96E" strokeWidth="0.5" />
        ...
        <div style={{ position:"absolute", inset:0, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"60px" }}>
          <div style={{ textAlign:"center", maxWidth:"380px" }}>
            ...
            <p style={{ fontFamily:"var(--font-display)", fontSize:"28px", fontWeight:"300", color:"rgba(255,255,255,0.7)", lineHeight:1.6, fontStyle:"italic", marginBottom:"24px" }}>
              « Le luxe, c'est la précision. Chaque minute compte. »
            </p>
            <div style={{ width:"40px", height:"1px", background:"rgba(201,169,110,0.4)", margin:"0 auto 32px" }} />
            <div style={{ fontSize:"11px", letterSpacing:"0.2em", textTransform:"uppercase", color:"rgba(201,169,110,0.5)" }}>
              LIVRR · Paris
            </div>
          </div>
          ...
          <div style={{ position:"absolute", bottom:"52px", display:"flex", gap:"48px" }}>
            {[
              ...
              <div key={s.label} style={{ textAlign:"center" }}>
                <div style={{ fontFamily:"var(--font-display)", fontSize:"28px", fontWeight:"300", color:"var(--gold)", lineHeight:1 }}>{s.value}</div>
